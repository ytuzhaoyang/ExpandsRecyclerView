    ...
    public void runPendingAnimations() {
        ...
        Collections.sort(mPendingRemovals, new Comparator<ViewHolder>() {
            ...
            public int compare(ViewHolder lhs, ViewHolder rhs) {
                return ((TreeAdapter.TreeViewHolder) lhs).getMyPosition()- ((TreeAdapter.TreeViewHolder) rhs).getMyPosition();
            }
        });
        // First, remove stuff
...
//                    }
    ...
    private void animateAddImpl(final ViewHolder holder, int i) {
        ...
        animation.setStartDelay(i * 100).translationX(0).setDuration(getAddDuration()).
